...
##
# To predict one record use predict(summaries, inputVector, priors)
# priors = Priors(train_target) calculate the propability of the each class
# summaries = summarizeByClass(train_data, train_target)
# seperate each class and get the mean and var in each class
##
